...
public class AddControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        Product product=new Product(pname, pimage, price, ptitle, pdescription, cateID,1, pmodel, pcolor, pdelivery, pimage2, pimage3, pimage4);
        dao.insertProduct(product);
        //dao.insertProduct(pname, pimage, pprice, ptitle, pdescription, pcategory, pmodel, pcolor, pdelivery, pimage2, pimage3, pimage4);
