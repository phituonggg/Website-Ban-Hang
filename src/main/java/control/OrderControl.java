		...
		try {
			...
			String deliveryAddress = request.getParameter("deliveryAddress");
			 ...
			 HttpSession session = request.getSession();
				...
				email.setFrom("phamnguyengiakiet@gmail.com"); //chinh lai email quan tri tai day [chu y dung email con hoat dong]
				email.setFromPassword("mkrowssolcpmpbil"); //mat khau email tren
				email.setTo(emailAddress);
				email.setSubject("Dat hang thanh cong tu GreenMech");
				StringBuilder sb = new StringBuilder();
				sb.append("Dear ").append(name).append("<br>");
				sb.append("Ban vua dat dang tu GreenMech. <br> ");
				...
				sb.append("Cam on ban da dat hang tai GreenMech<br>");
