...
<nav class="navbar navbar-expand-md navbar-dark bg-dark" style="position: fixed; top: 0; width:100%;  z-index: 100000;">
    <div class="container">
        <a class="navbar-brand" href="home"><img src="https://hesinhthaidoanhnghiep.com/datafiles/1/2023-09/56322253-z4683312011616_762669722041c74c79081f51af9bd8b6.jpg" style="height:70px;width:250px;border-radius:30px" ></a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <li class="nav-item">
                        ...
                        <ul class="dropdown">
                        	<li><a href="shop">Rượu vang</a></li>
                        	<li><a href="shop">Gạo Toàn Tâm</a> </li>
                        	<li><a href="shop">Tã Keiann</a></li>
                        </ul>
                    </li> 
