...
GO
select * from Product
ALTER TABLE Category where cid=
select   * from  Product order by id desc

delete  from Product where id=5
delete * frpm
INSERT [dbo].[Category] ([cid], [cname]) VALUES (1, N'Ruou Vang Nhap Khau')
INSERT [dbo].[Category] ([cid], [cname]) VALUES (2, N'Gao ST25')
INSERT [dbo].[Category] ([cid], [cname]) VALUES (3, N'Ta Keiann')
Go
SET IDENTITY_INSERT [dbo].[Supplier] ON 
INSERT [dbo].[Supplier] ([idSupplier], [nameSupplier], [phoneSupplier], [emailSupplier], [addressSupplier], [cateID]) VALUES (1, N'Cty TNHH GreenMech', N'0913778607', N'greenmechvietnam@gmail.com', N'Tầng 8, tòa nhà Pax Sky, số 34A Phạm Ngọc Thạch, Phường 06, Quận 3, TP Hồ Chí Minh.', 1)
INSERT [dbo].[Supplier] ([idSupplier], [nameSupplier], [phoneSupplier], [emailSupplier], [addressSupplier], [cateID]) VALUES (2, N'Cty TNHH GreenMech', N'0913778607', N'greenmechvietnam@gmail.com', N'Tầng 8, tòa nhà Pax Sky, số 34A Phạm Ngọc Thạch, Phường 06, Quận 3, TP Hồ Chí Minh.', 2)
INSERT [dbo].[Supplier] ([idSupplier], [nameSupplier], [phoneSupplier], [emailSupplier], [addressSupplier], [cateID]) VALUES (3, N'Cty TNHH GreenMech', N'0913778607', N'greenmechvietnam@gmail.com', N'Tầng 8, tòa nhà Pax Sky, số 34A Phạm Ngọc Thạch, Phường 06, Quận 3, TP Hồ Chí Minh.', 3)
SET IDENTITY_INSERT [dbo].[Supplier] OFF
Go
SET IDENTITY_INSERT [dbo].[Product] On
INSERT [dbo].[Product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID], [model], [color], [delivery]) VALUES (1, N'Rượu Vang Prince de Poujols-Chai đỏ', N'https://khoruouvangphap.vn/wp-content/uploads/2022/06/ruou-vang-hoang-tu-poujols-ca-tinh-cai-do.jpg', 590, N'Vang đỏ', N'
Loại vang: Vang đỏ'+ CHAR(13)+
N'.Quy cách: 750ml' +CHAR(13)+
N'.Giống nho: 100% Malbec'+ CHAR(13)+
N'.Tuổi thọ cây nho: 30 – 40 năm'+ CHAR(13)+
N'.Sản xuất rượu: Truyền thống đóng thùng 21 ngày và ủ rượu trong 18 tháng trong thùng gỗ Pháp' +CHAR(13)+
N'.Nồng độ: 13,5%' +CHAR(13)+
N'.Hãng sản xuất: Chateau Famaey – Pháp' , 1, 1, N'Cuvée Exception', N'Vang đỏ', N'TP.HỒ CHÍ MINH')
INSERT [dbo].[Product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID], [model], [color], [delivery]) VALUES (1, N'Rượu Vang Prince de Poujols-Chai đỏ', N'https://khoruouvangphap.vn/wp-content/uploads/2022/06/ruou-vang-hoang-tu-poujols-ca-tinh-cai-do.jpg', 590, N'Vang đỏ', N'
Loại vang: Vang đỏ'+ CHAR(13)+
N'.Quy cách: 750ml' +CHAR(13)+
N'.Giống nho: 100% Malbec'+ CHAR(13)+
...
N'.Sản xuất rượu: Truyền thống đóng thùng 21 ngày và ủ rượu trong 18 tháng trong thùng gỗ Pháp' +CHAR(13)+
N'.Nồng độ: 13,5%' +CHAR(13)+
N'.Hãng sản xuất: Chateau Famaey – Pháp' , 1, 1, N'Cuvée Exception', N'Vang đỏ', N'Toàn Quốc')
INSERT [dbo].[Product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID], [model], [color], [delivery]) VALUES (2, N'Rượu vang Hoàng Tử Poujols', N'https://khoruouvangphap.vn/wp-content/uploads/2022/06/ruou-vang-hoang-tu-poujols-co-dien-chai-xanh.jpg', 790, N'Vang đỏ', N'
Loại vang: Vang đỏ'+ CHAR(13)+
N'.Quy cách: 750ml' +CHAR(13)+
N'.Giống nho: 100% Malbec'+ CHAR(13)+
N'.Tuổi thọ cây nho: 30 – 40 năm'+ CHAR(13)+
N'.Sản xuất rượu: Truyền thống đóng thùng 21 ngày và ủ rượu trong 18 tháng trong thùng gỗ Pháp' +CHAR(13)+
N'.Nồng độ: 14,5%' +CHAR(13)+
N'.Hãng sản xuất: Chateau Famaey – Pháp' , 1, 1, N'Cuvée Exception', N'Vang đỏ', N'Toàn Quốc')
INSERT [dbo].[Product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID], [model], [color], [delivery]) VALUES (3, N'Rượu vang trắng Prince de Poujols', N'https://khoruouvangphap.vn/wp-content/uploads/2022/06/ruou-vang-trang-hoang-tu-poujols-nu-nhi.jpg', 500, N'Vang trắng', N'
Loại vang: Vang trắng'+ CHAR(13)+
N'.Quy cách: 750ml' +CHAR(13)+
N'.Giống nho: 100% Malbec'+ CHAR(13)+
N'.Tuổi thọ cây nho: 30 – 40 năm'+ CHAR(13)+
N'.Sản xuất rượu: Truyền thống đóng thùng 21 ngày và ủ rượu trong 18 tháng trong thùng gỗ Pháp' +CHAR(13)+
N'.Nồng độ: 10,5%' +CHAR(13)+
N'.Hãng sản xuất: Chateau Famaey – Pháp' , 1, 1, N'Le Cotes De Gascogne', N'Vang trắng', N'Toàn Quốc')


INSERT [dbo].[Product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID], [model], [color], [delivery],[image2], [image3]) VALUES (5, N'Bỉm quần KeiAnn', N'https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-lkrxwo4256ijfd', 200, N'Tã em bé', N'
Hãng sản xuất: KeiAnn'+ CHAR(13)+
N'.Được làm bằng chất liệu thoáng khí cao cấp, với hàng chục nghìn lỗ nhỏ để thông gió' +CHAR(13)+
N'.Tất cả hạt SAP siêu hấp thụ được nhập khẩu từ hãng Sumitomo Nhật Bản.Hấp thụ nhanh, dung lượng lớn.Chống thấm ngược, không đứt đoạn, không vón cục'+ CHAR(13)+
N'.Nâng cấp thêm lưng thun đệm mây cao và co giãn vừa vặn, ôm trọn vòng eo 360° không gây lằn bụng.'+ CHAR(13)+
N'.Sản xuất rượu: Truyền thống đóng thùng 21 ngày và ủ rượu trong 18 tháng trong thùng gỗ Pháp' +CHAR(13)
 , 3, 1, N'Tã quần cao cấp', N'Trắng-xanh', N'Toàn Quốc',N'https://keiann.com/wp-content/uploads/2023/07/about-23.png',N'http://keiann.com/wp-content/uploads/2023/07/about-17.png')
 INSERT [dbo].[Product] ([id], [name], [image], [price], [title], [description], [cateID], [sell_ID], [model], [color], [delivery],[image2], [image3]) VALUES (6, N'[2kg]Gạo ST25', N'https://down-vn.img.susercontent.com/file/bb1e5d2e23453f6b1f647a943016a680', 160, N'Gạo sạch Toàn Tâm Cà Mau', N'
Gạo chất lượng 100%, không pha trộn gạo rẻ tiền'+ CHAR(13)+
N'.Lúa được bảo quản trong kho kín, không dùng chất bảo quản' +CHAR(13)+
N'.Cám gạo sạch 100% nên nước vo gạo có thể dùng để rửa mặt, rửa thực phẩm'+ CHAR(13)+
N'.Gạo được xay xát bán ngay, không trộn chất bảo quản như chống mối, chống mọt chất tạo mùi, chất tạo dẻo, dầu bóng, bảo đảm an toàn cho sức khỏe.'+ CHAR(13)+
N'.Gạo được xay xát giữ nguyên cám dinh dưỡng, còn độ ngọt tự nhiên, mùi thơm tự nhiên, giữ nguyên chất gạo nguyên thủy' +CHAR(13)
 , 2, 1, N'Đặc sản Cà Mau, sản phẩm OCOP, hữu cơ', N'Gạo trắng', N'Toàn Quốc',N'https://down-vn.img.susercontent.com/file/d285124d6c3395e602e8facaa0752092',N'https://down-vn.img.susercontent.com/file/2b6374fd992b095c778b484f6b271179')

 SET IDENTITY_INSERT [dbo].[Account] OFF
INSERT [dbo].[Account] ([uID], [user], [pass], [isSell], [isAdmin], [email]) VALUES (1, N'phituong', N'123456    ', 1, 1, N'phituong@gmail.com')
Select * FROM TongChiTieuBanHang
select * from product
Select*  FROM ACCOUNT
select* from Invoice
